                    ...
                    <form method="POST" action="{{ route('admin.assessments.store') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control mt-2" id="doctor_name" name="doctor_name" type="text" value="{{ old('doctor_name') }}" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="doctor_name">Clinical Findings</label>
                                <textarea class="form-control" id="clinical_findings" name="clinical_findings" rows="8" required>{{ old('clinical_findings') }}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="fit_for_job_yes" name="fit_for_job" type="radio" value="1" {{ (old("fit_for_job") == '1' ? "checked" : "") }} required>
                                    <label class="form-check-label" for="fit_for_job_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="fit_for_job_no" name="fit_for_job" type="radio" value="0" {{ (old("fit_for_job") == '0' ? "checked" : "") }} required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="fit_for_driving_yes" name="fit_for_driving" type="radio" value="1" {{ (old("fit_for_driving") == '1' ? "checked" : "") }} required>
                                    <label class="form-check-label" for="fit_for_driving_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="fit_for_driving_no" name="fit_for_driving" type="radio" value="0" {{ (old("fit_for_driving") == '0' ? "checked" : "") }} required>
                                    <label class="form-check-label" for="fit_for_driving_no">No</label>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-outline-success pull-right">Submit Clinical Assessment</button>
                    </form>
                </div>
            </div>
        </div>
