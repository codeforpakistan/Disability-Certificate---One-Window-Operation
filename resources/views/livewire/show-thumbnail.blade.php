<div class="card" style="width: 12rem;">
  <img class="card-img-top" style="max-height:180px; max-width:180px; overflow:hidden;" src="{{ $resource->type == "application/pdf" ? asset('img/pdf.png') : $resource->url }}" alt="{{ $resource->name }}">
  <div class="card-body">
    ...
    <a href="{{ $resource->url }}" class="btn btn-primary" target="_blank">View / Download</a>
  </div>
</div>